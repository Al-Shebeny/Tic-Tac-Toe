...
class Game {
  ...
  Future<void> autoPlay(activePlayer) async {
    ...
    //start...end
      ...
      index = 4;
    else if (Player.playerO.containsAll(2, 8) && emptyCells.contains(6))
      index = 6;
    ...
    //center...end
      ...
      index = 1;
    else if (Player.playerO.containsAll(6, 8) && emptyCells.contains(2))
      index = 2;
    ...
    //start...end
      ...
      index = 4;
    else if (Player.playerX.containsAll(2, 8) && emptyCells.contains(6))
      index = 6;
    ...
    //center...end
      ...
      index = 1;
    else if (Player.playerX.containsAll(6, 8) && emptyCells.contains(2))
      index = 2;
